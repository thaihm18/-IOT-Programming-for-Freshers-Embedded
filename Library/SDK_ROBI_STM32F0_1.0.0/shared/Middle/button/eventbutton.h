...
typedef enum {
	...
	EVENT_OF_BUTTON_OK_PRESS_EDGE_RISING,
	EVENT_OF_BUTTON_CANCEL_PRESS_EDGE_RISING,

	EVENT_OF_BUTTON_BACK_PRESS_EDGE_FALLING,
	EVENT_OF_BUTTON_NEXT_PRESS_EDGE_FALLING,
	EVENT_OF_BUTTON_OK_PRESS_EDGE_FALLING,
	EVENT_OF_BUTTON_CANCEL_PRESS_EDGE_FALLING,

    EVENT_OF_BUTTON_BACK_PRESS_LOGIC,
    EVENT_OF_BUTTON_NEXT_PRESS_LOGIC,
    EVENT_OF_BUTTON_OK_PRESS_LOGIC,
    EVENT_OF_BUTTON_CANCEL_PRESS_LOGIC,

    EVENT_OF_BUTTON_BACK_PRESS_2_TIMES,
    EVENT_OF_BUTTON_NEXT_PRESS_2_TIMES,
    EVENT_OF_BUTTON_OK_PRESS_2_TIMES,
    EVENT_OF_BUTTON_CANCEL_PRESS_2_TIMES,

	EVENT_OF_BUTTON_BACK_PRESS_3_TIMES,
	EVENT_OF_BUTTON_NEXT_PRESS_3_TIMES,
	EVENT_OF_BUTTON_OK_PRESS_3_TIMES,
	EVENT_OF_BUTTON_CANCEL_PRESS_3_TIMES,

	EVENT_OF_BUTTON_BACK_PRESS_4_TIMES,
	EVENT_OF_BUTTON_NEXT_PRESS_4_TIMES,
	EVENT_OF_BUTTON_OK_PRESS_4_TIMES,
	EVENT_OF_BUTTON_CANCEL_PRESS_4_TIMES,

    EVENT_OF_BUTTON_BACK_PRESS_5_TIMES,
    EVENT_OF_BUTTON_NEXT_PRESS_5_TIMES,
    EVENT_OF_BUTTON_OK_PRESS_5_TIMES,
    EVENT_OF_BUTTON_CANCEL_PRESS_5_TIMES,

    EVENT_OF_BUTTON_BACK_HOLD_1S,
	EVENT_OF_BUTTON_NEXT_HOLD_1S,
	EVENT_OF_BUTTON_OK_HOLD_1S,
	EVENT_OF_BUTTON_CANCEL_HOLD_1S,

    EVENT_OF_BUTTON_BACK_HOLD_3S,
	EVENT_OF_BUTTON_NEXT_HOLD_3S,
	EVENT_OF_BUTTON_OK_HOLD_3S,
	EVENT_OF_BUTTON_CANCEL_HOLD_3S,

    EVENT_OF_BUTTON_BACK_HOLD_5S,
	EVENT_OF_BUTTON_NEXT_HOLD_5S,
	EVENT_OF_BUTTON_OK_HOLD_5S,
	EVENT_OF_BUTTON_CANCEL_HOLD_5S,

    EVENT_OF_BUTTON_BACK_HOLD_10S,
	EVENT_OF_BUTTON_NEXT_HOLD_10S,
	EVENT_OF_BUTTON_OK_HOLD_10S,
	EVENT_OF_BUTTON_CANCEL_HOLD_10S,

    EVENT_OF_BUTTON_BACK_RELEASED_1S,
    EVENT_OF_BUTTON_NEXT_RELEASED_1S,
    EVENT_OF_BUTTON_OK_RELEASED_1S,
    EVENT_OF_BUTTON_CANCEL_RELEASED_1S,

    EVENT_OF_BUTTON_BACK_RELEASED_3S,
    EVENT_OF_BUTTON_NEXT_RELEASED_3S,
    EVENT_OF_BUTTON_OK_RELEASED_3S,
    EVENT_OF_BUTTON_CANCEL_RELEASED_3S,

    EVENT_OF_BUTTON_BACK_RELEASED_5S,
    EVENT_OF_BUTTON_NEXT_RELEASED_5S,
    EVENT_OF_BUTTON_OK_RELEASED_5S,
    EVENT_OF_BUTTON_CANCEL_RELEASED_5S,

    EVENT_OF_BUTTON_BACK_RELEASED_10S,
    EVENT_OF_BUTTON_NEXT_RELEASED_10S,
    EVENT_OF_BUTTON_OK_RELEASED_10S,
    EVENT_OF_BUTTON_CANCEL_RELEASED_10S,
